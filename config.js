System.config({
  ...
  map: {
    ...
    "npm:init-package-json@1.9.3": {
      "fs": "github:jspm/nodelibs-fs@0.1.2",
      "glob": "npm:glob@6.0.4",
      "npm-package-arg": "npm:npm-package-arg@4.1.0",
      "path": "github:jspm/nodelibs-path@0.1.0",
      "promzard": "npm:promzard@0.3.0",
      "read": "npm:read@1.0.7",
      "read-package-json": "npm:read-package-json@2.0.3",
    ...
    "npm:lodash.union@4.2.1": {
      "lodash._baseflatten": "npm:lodash._baseflatten@4.1.1",
    ...
    "npm:npm@3.8.6": {
      ...
      "lodash.union": "npm:lodash.union@4.2.1",
